...
class MainWindow(QtWidgets.QWidget):
    def __init__(self, settings: Settings) -> None:
        ...
        self.checkbox_headless.setChecked(self.settings.is_admin)
        self.checkbox_headless.setEnabled(self.settings.is_admin)
        ...
        self.checkbox_auto_credentials.setEnabled(self.settings.is_admin)
